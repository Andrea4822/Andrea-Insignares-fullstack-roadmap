...
function encontrarParejasPotencialesPorEdad(personaObjetivo) {
    ...
    for (let persona of personas) {
        if ((persona.genero !== personaObjetivo.genero)
            && (persona.edad - personaObjetivo.edad <=5)&& (persona.ciudad == personaObjetivo.ciudad)) 
...
function encontrarParejaPorInteres(personaObjetivo){
    ...
    for (let persona=0; persona <personas.length ; persona ++) {
        for (let j=0; j <personas[persona].intereses.length; j++){
             if ((personas[persona].ciudad === personaObjetivo.ciudad) && (personas[persona].genero !== personaObjetivo.genero) && (personas[persona].intereses[j] == personaObjetivo.intereses[j]))
            parejasPotenciales.push(personas[persona]);
        }
    }
