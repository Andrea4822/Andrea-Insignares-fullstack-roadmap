...
/*function allHaveTitles(bookCollection){
    let result = bookCollection.every(libro => libro.title);
    return result;
...
/*function allHavePages (bookCollection){
    let result = bookCollection.every(pagesBook => pagesBook.pages > 0);
    return result;
}
...
/*function allAreAvailable (bookCollection){
    let result = bookCollection.every(availableBook => availableBook.isAvailable ===true)
    return result;
}
...
// Hint: `book.publicationYear > 1800`
 ...
 /*function allPost1800(bookCollection){
    let result= bookCollection.every(bookAfter => bookAfter.publicationYear >1800)
    return result;
}
...
/*function allHaveRatings(bookCollection){
    let result = bookCollection.every(booksRatings => booksRatings.ratings.length >0);
    return result;
}
...
/*function allHaveGenres(bookCollection){
    let result = bookCollection.every(bookGenr=> bookGenr.genre.length >0);
     return result;
}
...
/*function allHaveSummaries (bookCollection){
    let result = bookCollection.every(haveSummary => typeof haveSummary.summary === 'string')
    return result;
...
/*function allByFrankHerbert(bookCollection){
let result = bookCollection.every(write => write.author ==="Frank Herbert");
return result;
}
...
/*function allHaveISBN(bookCollection){
    let result = bookCollection.every( haveISBN => haveISBN.isbn);
    return result;
}
...
function allRatedAbove3( bookCollection){
    let result = bookCollection.every(rate => rate.ratings.find(r => r.source==="Goodreads").score> 3.0);
    return result;
}
