...
/*function hasGenre(bookCollection){
    let result = bookCollection. some (book => book.title=== "Dune" && book.genre.includes("Science Fiction"));
     return result;
    
}
console.log (hasGenre(bookCollection));*/
...
/*function hasKeyword(bookCollection){
    let result = bookCollection.some( wordCorrect => wordCorrect.keywords.includes("magic"));
    return result;
}
console.log(hasKeyword(bookCollection));*/
...
/*function checkTitleInCollection(bookCollection){
    let titles=  bookCollection.map(newArray => newArray.title);
    let result = titles.includes("1984");
    return result;
}
console.log (checkTitleInCollection(bookCollection));*/
...
/*function checkAuthor(bookCollection){
    let array = bookCollection.map(newArray => newArray.author);
    let result = array.includes("Jane Austen");
    return result;
}
console.log (checkAuthor(bookCollection));*/
...
/*function checkPublisherLocation(bookCollection){
    let location = bookCollection.map (newLocation => newLocation.publisher.location);
    let result= location.includes("Paris");
     return result;
}
console.log (checkPublisherLocation(bookCollection));*/
...
/*function checkPublicationYear(bookCollection){
    let array = bookCollection.map(containes => containes.publicationYear); 
    let result = array.includes(1965);
    return result;
}

console.log(checkPublicationYear(bookCollection));*/
...
/*function checkWordInSummary(bookCollection){
    let resul= bookCollection.some( book => book.title=== "Moby Dick" && book.summary.toLowerCase().includes("whale"));
    return resul;

}
console.log (checkWordInSummary(bookCollection));*/
...
/*function checkISBN(bookCollection){

    let result=  bookCollection.some(collecton => collecton.isbn === "978-0451524935");
     return result;
}
console.log(checkISBN(bookCollection));*/
...
/*function hasMultipleGenres(bookCollection){
    let result = bookCollection.some(b => b.title === "The Hobbit" && b.genre.includes("Fantasy")&& b.genre.includes("Adventure"));
     return result;
}
console.log(hasMultipleGenres(bookCollection));*/
...
function hasForbiddenKeyword(bookCollection){
    let result = bookCollection.some(b => b.title === "Pride and Prejudice" && b.keywords.includes("aliens"));
    return result;
}
console.log(hasForbiddenKeyword(bookCollection));
